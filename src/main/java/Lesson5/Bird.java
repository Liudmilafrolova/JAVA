...
public class Bird extends Animal {
    ...
    public Bird(int runLength, int swimLength, float jumpHeight) {
        super(runLength, swimLength,jumpHeight);
    }

    public void run() {

        System.out.println("Птичка бежит на " + runLength + "м");
    ...
    public void jump() {
        ...
        System.out.println("Птичка прыгает на " + jumpHeight + "м");
