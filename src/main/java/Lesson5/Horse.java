...
public class Horse extends Animal {
    ...
    public Horse(int runLength, int swimLength, float jumpHeight) {
        super(runLength, swimLength,jumpHeight);
    }

    public void run() {

        System.out.println("Лошадь бежит на " + runLength + "м");

    }
    public void swim() {

        System.out.println("Лошадь плывет на " + swimLength + "м");

    }
    public void jump() {

        System.out.println("Лошадь прыгает на " + (int) jumpHeight + "м");
